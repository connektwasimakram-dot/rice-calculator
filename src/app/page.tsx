...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* Hero Section - tightened top & bottom padding to remove open gaps */}
      <section className="relative overflow-hidden bg-slate-950 pt-8 pb-12 sm:pt-10 sm:pb-16 text-white border-b border-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 text-3xl font-semibold tracking-tight text-white sm:text-5xl text-balance">
              Reliable rice supply for institutional buyers and traders.
            </h1>

            <p className="mt-3 text-base leading-relaxed text-slate-300 max-w-2xl sm:text-lg">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <Link
                href="/calculator"
                className="inline-flex items-center justify-center gap-2 rounded-md bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-xs transition hover:bg-emerald-500 active:scale-[0.99]"
              >
              ...
              <a
                href="#corridor"
                className="inline-flex items-center justify-center rounded-md border border-slate-700 bg-slate-900/60 px-5 py-2.5 text-sm font-semibold text-slate-200 transition hover:bg-slate-800 hover:text-white"
              >
            ...
            <div className="mt-8 pt-6 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-4 text-left">
              <div>
                <span className="block text-xl sm:text-2xl font-semibold text-white font-mono tabular-nums">24–26 MT</span>
                <span className="mt-0.5 block text-xs text-slate-400">Payload per 20ft container</span>
              </div>
              <div>
                <span className="block text-xl sm:text-2xl font-semibold text-emerald-400 font-mono tabular-nums">INR / AED</span>
                <span className="mt-0.5 block text-xs text-slate-400">Direct FX cost parity</span>
              </div>
              <div>
                <span className="block text-xl sm:text-2xl font-semibold text-white font-mono tabular-nums">18 & 50 kg</span>
                <span className="mt-0.5 block text-xs text-slate-400">GCC packaging standards</span>
              </div>
              <div>
                <span className="block text-xl sm:text-2xl font-semibold text-white font-mono tabular-nums">Jebel Ali</span>
                <span className="mt-0.5 block text-xs text-slate-400">Primary discharge hub</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Services Section - compact padding */}
      <section id="services" className="py-12 sm:py-16 bg-white border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-1.5 text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl text-balance">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="group rounded-xl border border-slate-200 bg-slate-50/50 p-6 transition hover:border-slate-300 hover:bg-white hover:shadow-xs">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-900 text-white">
                <ShieldCheck className="h-5 w-5 text-emerald-400" />
              </div>
              <span className="mt-4 block text-xs font-mono text-slate-500 uppercase tracking-wider">
                01. Sourcing
              </span>
              <h3 className="mt-1.5 text-base font-semibold text-slate-900">Direct Mill Origination</h3>
            ...
            <div className="group rounded-xl border border-slate-200 bg-slate-50/50 p-6 transition hover:border-slate-300 hover:bg-white hover:shadow-xs">
              ...
              <h3 className="mt-1.5 text-base font-semibold text-slate-900">Multi-Currency Financial Modeling</h3>
              <p className="mt-2 text-xs leading-relaxed text-slate-600">
            ...
            <div className="group rounded-xl border border-slate-200 bg-slate-50/50 p-6 transition hover:border-slate-300 hover:bg-white hover:shadow-xs">
              ...
              <h3 className="mt-1.5 text-base font-semibold text-slate-900">Maritime Freight & Clearance</h3>
              <p className="mt-2 text-xs leading-relaxed text-slate-600">
      ...
      {/* Corridor Specifications - compact layout */}
      <section id="corridor" className="py-12 sm:py-16 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-slate-900">CEPA Preferential Rules of Origin</h4>
                    <p className="text-[11px] leading-relaxed text-slate-600">Eligible certificates of origin reduce or eliminate tariff friction under bilateral treaties.</p>
                  </div>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                  <div>
                    <h4 className="text-xs font-semibold text-slate-900">Standardized Packaging Configurations</h4>
                    <p className="text-[11px] leading-relaxed text-slate-600">PP, BOPP, and non-woven bags tailored for GCC retail supermarkets and institutional bulk caterers.</p>
                  </div>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" />
                  <div>
                    <h4 className="text-xs font-semibold text-slate-900">Guaranteed Container Slot Allocations</h4>
                    <p className="text-[11px] leading-relaxed text-slate-600">Fixed shipping schedules minimizing transit delays and port demurrage risks.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
              ...
              <div className="mt-5 rounded-lg bg-slate-50 p-3 border border-slate-100">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="block text-[11px] font-medium text-slate-500">Quotation Format</span>
                    <span className="text-xs font-semibold text-slate-900">Client-Ready PDF Export</span>
                  </div>
                  <Link
                    href="/calculator"
      ...
      {/* Dedicated calculator banner - streamlined */}
      <section className="bg-white py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl bg-slate-900 p-6 sm:p-8 text-white flex flex-col lg:flex-row lg:items-center justify-between gap-6 border border-slate-800">
            <div className="max-w-2xl">
              <span className="text-xs font-semibold uppercase tracking-wider text-emerald-400">
                Export quotation desk
              </span>
              <h2 className="mt-1.5 text-xl font-semibold tracking-tight sm:text-2xl text-balance">
            ...
            <Link
              href="/calculator"
              className="shrink-0 inline-flex items-center justify-center gap-2 rounded-md bg-emerald-600 px-5 py-2.5 text-xs font-semibold text-white shadow-xs transition hover:bg-emerald-500 active:scale-[0.99] whitespace-nowrap"
            >
      ...
      {/* Footer - compact */}
      <footer id="contact" className="bg-slate-950 text-slate-400 py-10 border-t border-slate-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="mt-3 flex flex-col space-y-1.5 text-xs">
          ...
          <div className="mt-8 pt-6 border-t border-slate-900 text-xs text-slate-400 flex flex-col sm:flex-row items-center justify-between gap-3">
