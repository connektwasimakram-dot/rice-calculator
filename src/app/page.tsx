...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/calculator" className="bg-[#28A745] hover:bg-[#218838] text-white px-8 py-4 rounded-lg font-bold text-lg text-center transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                Open P&L Calculator
              </Link>
      ...
      {/* Dedicated calculator entry point */}
      <section className="bg-gray-50 px-4 py-20">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 rounded-2xl bg-[#003366] p-8 text-white shadow-xl sm:p-12 lg:flex-row lg:items-center">
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.14em] text-[#a4ddb0]">
              Export quotation desk
            </span>
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
              Know the landed economics before you quote.
            </h2>
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/70">
              Model your container costs, target pricing, ROI, per-kilogram landing cost and
              18kg bag pricing in a dedicated workspace.
            </p>
          </div>
          <Link
            href="/calculator"
            className="shrink-0 rounded-lg bg-white px-6 py-3 font-bold text-[#003366] transition hover:-translate-y-0.5 hover:bg-[#effff2]"
          >
            Open calculator ↗
          </Link>
        </div>
